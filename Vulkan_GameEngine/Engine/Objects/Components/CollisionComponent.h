...
protected:
	...
	static bool RayBoundingBoxCollision(const Ray& ray, const FVector3& min, const FVector3& max, FVector3 collisionPoints[2], S_CollisionData& data, bool stopAtFirstCollision = true);
